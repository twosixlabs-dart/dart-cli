...
from dart_cli.pipeline.deploy import get_deploy_opts
from dart_cli.utilities.docker_utils import run_dart_docker_command
...
def stop_containers_clear_data(dart_context, ec2_ini_path):
    opts = get_deploy_opts(dart_context, ec2_ini_path)
